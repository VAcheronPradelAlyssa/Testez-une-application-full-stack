...
class SessionControllerTest {
    ...
    @Test
    @WithMockUser
    void shouldBadRequestUpdate() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldBadRequestWhenFieldMissing() throws Exception {
        SessionDto session = new SessionDto();
        session.setId(1L);
        // Ne pas mettre de name, date, etc.
    ...
    @Test
    @WithMockUser
    void shouldNotFoundDelete() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldBadRequestDelete() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldBadRequestParticipate() throws Exception {
    ...
    @Test
    @WithMockUser
    void shouldBadRequestNoLongerParticipate() throws Exception {
